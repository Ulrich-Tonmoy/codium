...
import { MainContext } from "@/libs/explorerBuilder";
import * as monaco from "monaco-editor";
import { getFileTypes } from "@/libs/explorerBuilder";
import { TSelectedFile } from "@/libs/types";
import { useAppDispatch, useAppSelector } from "@/libs/hooks";
import { Footer } from "./sections/Footer";
import { updateActiveFiles, updateIndent } from "@/libs/editorSlice";
import { writeFile } from "@/libs/fsUtils";
import { store } from "@/libs/store";
import { Header } from "./sections/Header";

export const Codium = memo((props: any) => {
  ...
  useEffect(() => {
    // TODO: Remove this if don't wanna save on blur
