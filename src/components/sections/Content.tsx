import {
  ...
  updateActiveFile,
  updateActiveFiles,
} from "@/libs/editorSlice";
import { useAppDispatch, useAppSelector } from "@/libs/hooks";
import { getFolderTree } from "@/libs/fsUtils";
import { memo, useCallback, useContext } from "react";
import { CloseIcon, VSCodeIcon } from "../icons";
import { TActiveFile } from "@/libs/types";
import { MainContext } from "@/libs/explorerBuilder";

export const Content = memo((props: any) => {
